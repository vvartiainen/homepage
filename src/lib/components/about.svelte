<section
	class="mb-10 text-center font-mono md:flex items-center justify-center md:text-left md:text-xl lg:text-2xl"
>
	...
	<div class="flex max-w justify-center items-center pt-10 md:w-1/3">
		<img src="profilepic.png" alt="profile-pic" class=" items-center rounded-full" />
	</div>
</section>
