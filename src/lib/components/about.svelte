<section
	class="mb-10 text-center font-mono md:flex md:items-center md:justify-center md:text-left md:text-xl lg:text-2xl"
>
	...
	<div class="flex max-w-md justify-center pt-10 md:w-1/3">
