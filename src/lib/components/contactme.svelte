<div class="mb-5 flex items-center justify-center font-mono">
...
<div class="mb-5 mt-5 flex justify-center font-mono text-xl font-extrabold text-sky-400">
	<p class="font-mono text-2xl font-bold text-sky-400">Check out my socials!</p>
</div>
...
<div class="mb-5 mt-8 flex justify-center font-mono text-sm font-extralight italic">
